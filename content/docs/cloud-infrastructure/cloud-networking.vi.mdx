...
Cloud networking dễ vận hành hơn nhiều khi bạn ngừng hỏi “network có mở không?” và thay vào đó lần theo **đường đi của gói tin** như một chuỗi quyết định:

1. Source và destination đang dùng địa chỉ nào?
2. Route nào match destination, và nó chọn target hay next hop nào?
3. Gateway hoặc NAT có thay đổi đường đi hay địa chỉ không?
4. Policy ingress và egress nào cho phép hoặc từ chối flow?
5. Return path có quay lại source được không?

DNS, IAM, TLS và application authorization đều quan trọng, nhưng trả lời các câu hỏi khác nhau. DNS phân giải thành công không chứng minh khả năng kết nối mạng; network reachability cũng không chứng minh ứng dụng sẽ cho phép request.
