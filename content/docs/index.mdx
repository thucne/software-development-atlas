...
Start with [How to use the Atlas](/docs/start-here/how-to-use-the-atlas), explore the [Software Engineering Map](/docs/start-here/software-engineering-map), then read [Content freshness](/docs/start-here/freshness) to understand how evolving guidance is reviewed.
