...
### September 17, 2026 · Distributed Replication

The Atlas adds **1 canonical distributed-systems deep dive** that separates replication mechanics from consistency and consensus while keeping failover authority, recovery, and reconciliation explicit.
