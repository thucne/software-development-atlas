...
### September 17, 2026 · Distributed Replication & Consensus

The Atlas adds **2 canonical distributed-systems deep dives** that separate replication mechanics from consensus agreement while keeping failover authority, committed history, quorum behavior, recovery, and reconciliation explicit.
