---
title: Bản đồ Kỹ thuật Phần mềm
...
Bản đồ Kỹ thuật Phần mềm (Software Engineering Map) là danh mục chuẩn hóa toàn bộ lãnh thổ tri thức kỹ thuật mà Atlas dự định bao phủ. Bản đồ này được lưu trữ tại file `content/atlas-map.json` để con người, bộ kiểm thử tự động, công cụ và các AI coding agent cùng chia sẻ chung một hệ từ vựng ổn định.
...
```mermaid
graph LR
  A["Kỹ thuật Phần mềm"] --> CF["Nền tảng Điện toán"]
...
**Nội dung (Content)** trả lời câu hỏi: *Tôi cần hiểu mô hình tư duy, quy tắc kỹ thuật hay kỹ năng thực hành nào ở đây?* Nội dung có thể là một ghi chú khái niệm súc tích, một bài phân tích sâu (deep dive), một hướng dẫn ra quyết định (decision guide), một cẩm nang thực địa (field guide), hoặc một phân tích kiến trúc thực tế (architecture walkthrough).
...
**Hướng dẫn ra quyết định (Decision guide)** trả lời câu hỏi: *Với những ràng buộc và đánh đổi kỹ thuật nhất định, khi nào nên chọn giải pháp này thay vì giải pháp khác?* Hướng dẫn ra quyết định là tài liệu học tập hạng nhất, không phải bảng xếp hạng độ phổ biến của các framework.
