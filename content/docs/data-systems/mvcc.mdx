...
<TermBox term="VACUUM">
In PostgreSQL, **VACUUM** performs maintenance including reclaiming or making reusable space from obsolete row versions, maintaining planner statistics/visibility information, and protecting against transaction ID wraparound.
...
PostgreSQL's routine vacuuming documentation lists several reasons for regular vacuuming, including reclaiming updated/deleted row-version space, maintaining planner statistics and the visibility map, and preventing transaction ID wraparound problems.
