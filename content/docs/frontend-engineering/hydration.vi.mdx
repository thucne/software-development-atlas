...
# Hydration: Biến HTML Đã Render Thành Ứng Dụng Có Thể Tương Tác

## Tóm tắt

Server rendering có thể làm HTML hiển thị trước khi trình duyệt tải và chạy application runtime. **Hydration là bước phía client gắn component logic và event behavior vào HTML đã tồn tại để UI trở nên tương tác được.**

Vì vậy HTML đã nhìn thấy và ứng dụng đã tương tác được là hai mốc khác nhau.
...
<details>
<summary>Xem phần giải thích</summary>
