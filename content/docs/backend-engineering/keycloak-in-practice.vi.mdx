...
Với browser-only JavaScript, tài liệu Keycloak nói client phải là public client vì không có cách an toàn để giữ client credential trong client-side code.
